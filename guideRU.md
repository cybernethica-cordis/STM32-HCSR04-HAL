...
- **HCSR04-UART-HAL.elf**. Файл прошивки в формате ELF (для отладки и разработки);
...
> Если вывод в терминале не совпадает с указанными контрольными суммами, не стоит загрушать прошивку в микроконтроллер. Файл мог быть поврежден во время загрузки. В таком случае лучше заново скачать файл и повторить проверку.
